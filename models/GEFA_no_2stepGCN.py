...
class GEFA_no_2stepGCN(torch.nn.Module):
    def __init__(self, num_features_xd, num_features_xt,
        ...
        # SMILES graph branch
        self.rblock_xd = ResidualBlock(num_features_xd)
        self.fc_g1_d = torch.nn.Linear(num_features_xd, 1024)
        ...
        self.conv1_xt = GCNConv(num_features_xt, latent_dim*2)
